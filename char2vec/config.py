...
CHAR2VEC_DOMAIN_MODEL_SAVE_PATH = os.path.join(CUR_TO_DATASET_PATH, 'model/domain_char2vec.cv')
CHAR2VEC_PATH_MODEL_SAVE_PATH = os.path.join(CUR_TO_DATASET_PATH, 'model/path_char2vec.cv')
